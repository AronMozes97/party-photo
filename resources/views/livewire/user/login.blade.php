<div class="mx-auto max-w-md py-10">
    ...
    @error('loginError')
    <div class="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-100 flex justify-center align-center" role="alert">
    ...
    <form wire:submit="login" class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            ...
            <a href="#" class="text-sm text-indigo-600 hover:underline">Elfelejtett jelszó?</a>
        </div>
